...
def main():
    detpath = r'/home/ps/BBAVectors-Oriented-Object-Detection(sjw)/result_hrsc/Task1_{:s}.txt'
    annopath = r'/home/ps/BBAVectors-Oriented-Object-Detection(sjw)/datasets/HRSC2016/Annotations/{:s}.xml' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/home/ps/BBAVectors-Oriented-Object-Detection(sjw)/datasets/HRSC2016/test.txt'
    classnames = ['ship']
    classaps = []
    map = 0
