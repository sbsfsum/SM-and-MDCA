...
def parse_args():
    ...
    parser.add_argument('--init_lr', type=float, default=6.25e-4, help='Initial learning rate') # 6.25
    parser.add_argument('--input_h', type=int, default=640, help='Resized image height')  # 640
    parser.add_argument('--input_w', type=int, default=800, help='Resized image width')   # 800
    ...
    parser.add_argument('--data_dir', type=str, default='/home/ps/BBAVectors-Oriented-Object-Detection(sjw)/datasets/HRSC2016', help='Data directory')
